...
>
> This code demonstrates text processing, data cleaning and the creation of bigrams and sentiment analysis from Baltimore Sun coverage of Cheltenham
...
```{r message=FALSE, warning=FALSE}
bal_sun <- read_csv ("./output/bal_sun_march_24_articles.csv") 
```
